...
export const worryStatuses: WorryStatusOption[] = [
  ...
  { value: "내려놓기", label: "내려놓기", desc: "지금 내가 통제할 수 없는 고민이에요.", tone: "release" },
];
...
export const seedWorries: WorryItem[] = [
  ...
  createSeedWorry("seed-2", "예시) 주말 약속을 잡을지 말지 고민된다", "관계", "보류", "금요일 컨디션 보고 답장하기"),
  createSeedWorry("seed-3", "예시) 돈을 조금 더 아껴야 할 것 같다", "돈", "기록", "이번 달 고정지출 먼저 확인하기"),
  createSeedWorry("seed-4", "예시) 해외여행을 가고싶다.", "기타", "내려놓기", "자제하자."),
];
